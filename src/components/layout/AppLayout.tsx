    ...
    <div className="flex flex-col h-full bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border-r border-border p-6">
      ...
      <div className="mt-auto pt-6 border-t border-border">
        ...
        <a 
          ...
          className="flex items-center gap-3 px-4 py-3 mb-4 rounded-xl transition-all duration-200 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold hover:bg-emerald-500/20 group cursor-pointer"
        >
